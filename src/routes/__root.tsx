...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BLVCK KINGS Cider — Premium British Cider" },
      { name: "description", content: "8.4% ABV Premium Strong British Cider by L&K Meadows Ltd, Birmingham. Wholesale export to Africa." },
